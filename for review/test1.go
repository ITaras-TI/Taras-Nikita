...
func main() {
	for x := 5; x >= 0; x-- {
		...
		if input_integer1 > input_integer2 && input_integer1 > input_integer3 {
			fmt.Println(input_integer1, "- MAX")
		} else if input_integer2 > input_integer1 && input_integer2 > input_integer3 {
			fmt.Println(input_integer2, "- MAX")
		} else if input_integer3 > input_integer1 && input_integer3 > input_integer2 {
			fmt.Println(input_integer3, "- MAX")
		}
		if input_integer1 < input_integer2 && input_integer1 < input_integer3 {
			fmt.Println(input_integer1, "- MIN")
		} else if input_integer2 < input_integer1 && input_integer2 < input_integer3 {
			fmt.Println(input_integer2, "- MIN")
		} else if input_integer3 < input_integer1 && input_integer3 < input_integer2 {
			fmt.Println(input_integer3, "- MIN")
		}
	}
}
